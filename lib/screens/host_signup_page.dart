...
class HostSignupPage extends StatefulWidget {
  const HostSignupPage({Key? key}) : super(key: key);

  @override
  State<HostSignupPage> createState() => HostSignupPageState();
}

class HostSignupPageState extends State<HostSignupPage> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Padding(
                      padding: EdgeInsets.only(bottom: 45.0 , top: 30),
                      child: Text('Devenir hôte',
